...
namespace DAL.Context
{
    internal class DropCreateDeliveryDatabaseAlways : DropCreateDatabaseAlways<DeliveryContext>
    {
        protected override void Seed(DeliveryContext context)
        {
            ...
            Order order1 = new Order { Details = "1 order", Dishes = new List<Dish> { soup, tea, burger } };
            Order order2 = new Order { Details = "2 order", Dishes = new List<Dish> { coffee, cake, cake, pudding } };
